...
<template>
  <teleport to="body">
    <div
      class="absolute top-0 left-0 right-0 bottom-0 w-full min-h-screen bg-stone-700 bg-opacity-50 backdrop-blur-[2px] backdrop"
      :class="isOpenModal ? '' : 'invisible -z-10'"
      @click="handlerBackdropClick"
    >
      <div class="container">
        <div
          class="transition-all flex justify-center items-center backdrop"
          :class="
            isOpenModal
